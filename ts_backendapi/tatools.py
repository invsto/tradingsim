...
class Indicators:
    ...
    def addmovingav(self, periods: list=[9,20,21,50,200]):
        ...
        try:
            for period in periods:
                ...
                self.dataf[columnname]=sma_indicator(self.dataf['ClosePrice'],window=period)
    ...
    def addrsi(self, period=14):
        ...
        try:        
            #adding column rsi
            self.dataf['rsi']=rsi(self.dataf['Close'],window=period)
    ...
    def addbb(self, period=14):
        ...
        try:
            #create bbobj                
            bbobj=BollingerBands(self.dataf['Close'],window=period)
